...
INSERT INTO `movies` VALUES (1,'Pulp Fiction','Crimen','https://pics.filmaffinity.com/pulp_fiction-210382116-large.jpg','Top 10',1994),(2,'La vita è bella','Comedia','\nhttps://pics.filmaffinity.com/la_vita_e_bella-646167341-mmed.jpg','Top 10',1997),(3,'Forrest Gump','Comedia','https://pics.filmaffinity.com/forrest_gump-212765827-mmed.jpg','Top 10',1994);
...
CREATE TABLE `users_has_movies` (
  ...
  PRIMARY KEY (`users_idUser`,`movies_idMovie`),
  KEY `fk_users_has_movies_movies1_idx` (`movies_idMovie`),
  KEY `fk_users_has_movies_users1_idx` (`users_idUser`),
  CONSTRAINT `fk_users_has_movies_movies1` FOREIGN KEY (`movies_idMovie`) REFERENCES `movies` (`idMovie`),
  CONSTRAINT `fk_users_has_movies_users1` FOREIGN KEY (`users_idUser`) REFERENCES `users` (`idUser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users_has_movies` VALUES (1,1,6),(1,2,3),(3,2,7);
...
-- Dump completed on 2025-06-17 12:05:30
